...
var WrappedActivity = (function (_super) {
    ...
    WrappedActivity.prototype.handleKeyPress = function (event) {
    ...
    WrappedActivity.prototype.render = function () {
        ...
        var selectable = this.props.onClickActivity;
        ...
        return (React.createElement("div", { className: wrapperClassName, "data-activity-id": this.props.activity.id, onClick: this.props.onClickActivity, onKeyUp: this.handleKeyPress, role: selectable ? 'button' : undefined, tabIndex: selectable ? 0 : undefined },
